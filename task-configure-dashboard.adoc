...
summary: Konfigurieren Sie das EDA-Projekt-Dashboard, indem Sie Tags hinzufügen, um Kennzahlen zu erfassen. Passen Sie Filter mit Einzel- oder Mehrfachauswahloptionen an Ihre Geschäftsanforderungen an. 
---
