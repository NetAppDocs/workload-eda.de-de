...
summary: Konfigurieren Sie das EDA-Projekt-Dashboard, indem Sie Tags hinzufügen, um Kennzahlen zu erfassen. Passen Sie die Filter mit Einzel- oder Mehrfachauswahloptionen an Ihre Geschäftsanforderungen an. 
---
...
NOTE: Nur der erste Administrator, der auf das Projekt-Dashboard zugreift, kann benutzerdefinierte Filter konfigurieren, hinzufügen oder löschen. Alle anderen Benutzer, einschließlich nachfolgender Administratoren, haben nur Lesezugriff auf die Filter.
