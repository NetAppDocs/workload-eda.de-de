...
Alle erkannten Ereignisse erscheinen in der Tabelle der Latenzereignisse. Wenn Benachrichtigungen eingerichtet sind, wird zusätzlich eine E-Mail oder eine Amazon SNS-Nachricht mit Details zu den betroffenen Volumes empfangen.
